...
function storyCard(props) {
  return (
    <div className="story-card" onClick={props.postEditor}>
      <div className="story-card__title" onClick={props.postEditor}>
        {props.card.title}
      </div>
      ...
      <button
        className="written-by story-card__by"
        onClick={props.profileViewer}
      >
        <div className="">by-{props.card.createdBy}&nbsp;</div>
      </button>
    </div>
  );
}
